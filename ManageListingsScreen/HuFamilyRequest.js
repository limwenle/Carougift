	...
	return (
        ...
        */}
				...
				<Text style={styles.sultanaDescription}>
					I have 7 children at home in between ages of 4-17. Everyone
					is at home studying. Live in 2 room flat at Tan Kah Kee
					area. There is not enough studying space. Only have 2
					laptops at home, for 6 children to share. Slow internet.
					They are not very smart. They do homework slow, means other
					siblings cannot use laptop. {"\n"}
				</Text>
