...
function MultipleListingsPage({ navigation }) {
  return (
    <>
      ...
      >
        Help out these people who are struggling in this global health crisis.
      </Text>
      ...
      <ScrollView style={{ top: 30 }}>
        ...
        >
          ...
          >
            Donate to help Sultana Bookstore stay afloat during the crisis.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{
        ...
        >
          ...
          >
            Help Uncle Lee's business remain profitable in this crisis.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{
        ...
        >
          ...
          >
            Help Alice, who doesn't have access to a laptop for home-based
            learning.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          >
            Provide sewing materials for Mdm Rosli to sew masks for our health
            workers.
          </Text>
        </TouchableOpacity>
      </ScrollView>
