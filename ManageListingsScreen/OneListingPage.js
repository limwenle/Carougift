    ...
    <>
      <ScrollView>
        ...
        <Text style={{ textAlign: "center", fontSize: 18, color: "black" }}>
          ...
          have not been able to operate. Though there have been grants given by
          the government, we are unable to sustain our losses at this rate. We
          are seeking donations to keep our old-fashioned bookstore afloat. Any
          amount will be appreciated, thank you!
        </Text>

        <Text
          style={{ textAlign: "center", fontSize: 20, color: "maroon", top: 5 }}
        >
          Target Amount: $1000
        </Text>
