  ...
  return (
    <>
      <View style={styles.pfpName}>
        <Image style={styles.pfp} source={require("./app/assets/pfp.jpg")} />
        <Text style={{ fontSize: 20, top: 200 }}>Account Name</Text>
      </View>

      <TouchableOpacity style={styles.makeList}>
        <Text style={{ fontSize: 20, color: "white" }}>Make A listing</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.manageList}>
        <Text style={{ fontSize: 20, color: "white" }}>Manage My Listings</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.viewAccount}>
        <Text style={{ fontSize: 20, color: "white" }}>View My Account</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.messages}>
        <Text style={{ fontSize: 20, color: "white" }}>View My Messages</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          Alert.alert("Logout", "Confirm Logout?", [
            { text: "Yes", onPress: () => console.log("edit later") },
            { text: "No" },
          ])
        }
      >
